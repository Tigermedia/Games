...
class EDR_Admin {
    ...
    public function add_admin_menu() {
        ...
        // Sumit Accounts submenu
        add_submenu_page(
            'elementor-dynamic-redirect',
            __('Sumit Accounts', 'elementor-dynamic-redirect'),
            __('Sumit Accounts', 'elementor-dynamic-redirect'),
            'manage_options',
            'elementor-dynamic-redirect-sumit-accounts',
            array($this, 'render_sumit_accounts_page')
        );
    ...
    public function sanitize_settings($input) {
        ...
        // Add Sumit Account setting
        if (isset($input['pilatis_sumit_account'])) {
            $sanitized['pilatis_sumit_account'] = sanitize_text_field($input['pilatis_sumit_account']);
        } else {
            $sanitized['pilatis_sumit_account'] = 'stern_sports';
        }
    ...
    /**
     * Render sumit accounts page
     */
    public function render_sumit_accounts_page() {
        if (!current_user_can('manage_options')) {
            return;
        }

        EDR_Sumit_Accounts::instance()->render_page();
    }
